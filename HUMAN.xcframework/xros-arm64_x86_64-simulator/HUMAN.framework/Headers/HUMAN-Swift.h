...
///
- (BOOL)handleBlockResponseWithData:(NSData * _Nonnull)data url:(NSString * _Nullable)url callback:(void (^ _Nullable)(enum HSBotDefenderChallengeResult))callback SWIFT_WARN_UNUSED_RESULT;
