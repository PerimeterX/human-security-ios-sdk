...
///
- (BOOL)canHandleResponseWithResponse:(NSURLResponse * _Nonnull)response data:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
///
- (BOOL)handleResponseWithResponse:(NSURLResponse * _Nonnull)response data:(NSData * _Nonnull)data callback:(void (^ _Nullable)(enum HSBotDefenderChallengeResult))callback SWIFT_WARN_UNUSED_RESULT;
